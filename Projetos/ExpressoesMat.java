...
public class ExpressoesMat{
  public static void main(String[] args) {
    ...
    while (true){
      ...
      if (opc == 1){
        ...
        entradaValores(expressaoInfixa);
      } else if (opc == 3){
        System.out.print("A expressao posfixa e: ");
        Conversor(expressaoInfixa);
      } else if (opc == 4){
        int resultado = atribuirValores(expressaoInfixa, valores);
  ...
  public static void Conversor(String expressao){
  ...
  // Função que recebe as números para variáveis
  public static void entradaValores(String expressao){
